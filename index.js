...
function busca(valor) {
	...
	if (valor.length === 0) {
		...
		if (valor.toLowerCase() === 'java') valor = 'java ';
		result = listaArchivos.filter(function (val) {
			return val.name.toLowerCase().includes(valor.toLowerCase());
		});
	}
...
function obtenerCertificados() {
	return __awaiter(this, void 0, void 0, function () {
		...
		return __generator(this, function (_a) {
			switch (_a.label) {
				case 0:
					return [4 /*yield*/, fetch('https://api.github.com/repos/giacca90/SobreMi/contents/certificados')];
				case 1:
					response = _a.sent();
